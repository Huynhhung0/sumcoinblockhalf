...
define("SEGWIT_SIGNAL_START",        200);
define("SEGWIT_PERIOD_START",        200);
define("BLOCK_RETARGET_INTERVAL",    2880);
...
$sumcoin = new jsonRPCClient('http://user:pass@127.0.0.1:3332/');
$blockCount = $sumcoin->getblockcount();
$blockChainInfo = $sumcoin->getblockchaininfo();
...
$blockHeight2880 = $mem->get("blockheight_2880");
...
CheckBlocks($blockHeight, $blockCount, $mem, $sumcoin, $blocksSincePeriodStart);
CheckBlocks($blockHeight2880, $blockCount, $mem, $sumcoin, BLOCKS_PER_DAY, '_2880');
CheckBlocks($blockHeight8064, $blockCount, $mem, $sumcoin, BLOCK_SIGNAL_INTERVAL, '_8064');
...
if ($jsonOutput) {
	$response = array(
		"last2880" => array(
			...
			"toHeight" => $blockCount,
			"stats" => GetBlockRangeStats($versions, BLOCKS_PER_DAY, $mem, '_2880')
			),
		"last8064" => array(
...
<head>
	...
	<meta name="description" content="Sumcoin Segregated Witness Website">
	<meta name="author" content="">
	<link rel="icon" href="favicon.ico">
	<title>Sumcoin Segregated Witness Adoption Tracker</title>
	<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.1/css/bootstrap.min.css">
	<link rel="stylesheet" href="css/flipclock.css">
	<script src="http://ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js"></script>
	<script src="js/flipclock.js"></script>
	<style type="text/css">
		.progress {height: 70px; margin-bottom: 0px; margin-top: 30px; }
	</style>
</head>
<body>
	<div class="container">
			...
			<br/><br/>
				<?php
						...
						if ($segwitStatus == "locked_in") {
							$text = 'SegWit for Sumcoin has succesfully locked in! A big thank you to the Sumcoin/Bitcoin communities, the Sumcoin/Bitcoin developers and the miners for making this possible! After activation period 7, SegWit for Sumcoin will be active.';
						} else if ($segwitStatus == "active") {
							$text = 'SegWit for Sumcoin has succesfully activated! A big thank you to the Sumcoin/Bitcoin communities, the Sumcoin/Bitcoin developers and the miners for making this possible! Arise chickun!';
						}
						echo '<b>'. $text . '</b>';
				 ?>
			<?php
	...
	<div align="center">
		...
		?>
		<img src="../images/sumcoin.png" width="125px" height="125px">
	</div>
	<br/>
	<footer>
